...
//                return view('user.basic_info'); // 이름 & 닉네임 설정은 필수
        ...
        $faqs = [
            ...
            [
                ...
                'answer' => "매주 주보에서 <b>'세계망대 파수꾼 작정현황표'</b>를 확인하시거나, 세계망대앱을 활용하셔서 237 나라 중 비어있는 <b>빈 곳</b>에 작정하시면 됩니다. <br/> 임마누엘교회 본당에 있는 작정서에 성도님의 기본 정보와 작정하실 나라를 기재하시고 교회에 비치되어있는 작정함에 넣어주세요. <br/> 작정하신 내용은 다음주 주보에서 확인하실 수 있습니다. ",
            ],
            [
                'question' => "마음에 두고 기도하던 나라가 있는데 이미 마감되었어요😭",
                'answer' => "아쉽지만 다른 나라를 작정해주셔야합니다. 237 모든 나라에 빈 곳이 없도록, 임마누엘교회 모든 성도님들이 237나라를 마음에 품을 수 있도록 각 나라에 제한인원을 두었습니다.(장로 1명, 권사 3명, 렘넌트 2명, 성도 5명) <br/> 지금까지 기도해오시던 나라는 계속해서 기도하시면서, 237나라를 살리기 위해 빈 곳 한 나라에 망대를 세우는 일에 함께해주세요.",
            ],
            [
                'question' => "언제까지 작정해야해요?",
                'answer' => "10월 1일 주일까지 작정서를 제출해주시면 됩니다. 10월 8일 주일부터는 아직 작정을 하지않으신 분들과 중복으로 작정되신 분들을 대상으로 <b>빈 곳 작정 제비뽑기</b>를 진행하게 됩니다.<br/><b>빈 곳 작정 제비뽑기<b/>는 하나님의 인도를 따라 제비를 뽑아 237나라 빈 곳에 작정하시도록 준비하고 있습니다.",
            ],
            [
