...
<div id="nation_container" class="slick w-full px-8" style="padding: 5vh 3vh; max-width: 1900px; justify-content: center; overflow: scroll; height: 100vh; margin : 0px auto;">
    ...
    <div class="nation_card  p-5 m-3 relative" style="height:80vh">
        ...
        <div class="p-5 w-full rounded-lg border-{{$bartizan->getColor()}}-500 border-2 shadow bg-gray-200 h-full ">
            <div class="bg-white rounded-lg p-5">
                <p class="text-xl pb-1 text-gray-900">
                ...
                <div class="flex">
                    <img src="{{env("NCLOUD_FLAG_PATH")}}/{{strtolower($bartizan->country_code)}}.svg" class="inline-block"
                         style="border:2px solid #ddd; object-fit: contain; height: 100px; width: auto; " alt="img.."/>

                    <div class="flex flex-col font-bold" style="height: 50px;">
...
<script>
    ...
    const TOTAL = {{count($bartizans)}};
    $('.slick').on('afterChange', function(event, slick, currentSlide){
        console.log("currentSlide", currentSlide);
        if(currentSlide >= TOTAL - 1){
            console.log("LAST SLIDE >> RELOAD!");
            // alert("LAST SLIDE >> RELOAD!");
            location.reload();
        }
    });
</script>
