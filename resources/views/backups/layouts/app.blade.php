...
{{--            <ul class="lg:hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">--}}
...
{{--        </div>--}}
        ...
        <header id="header-bar" class="flex w-full border-b border border-gray-100 bg-white fixed top-0 left-0" style="height: 60px; z-index: 10;">
            <div class="" style="padding:10px 20px">
                <a href="/home">
                    <img width="100" height="40" src="https://kr.object.ncloudstorage.com/immanuel/ddeul/logo.png">
                </a>
            </div>
        </header>

        <section style="margin-top:60px; padding: 0px 0 60px 0;">
            @yield('content')
        </section>


        <!-- BOTTOM NAV BAR -->
        <div class="bg-white fixed bottom-0 w-full border-t border-gray-200 flex" style="z-index: 10; margin-top:60px">
