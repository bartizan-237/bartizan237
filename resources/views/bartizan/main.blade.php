...
@section('content')
    <main class="sm:mx-auto h-full relative" style="max-width: 500px;">
        <div class="bg-gray-200 p-2 min-h-full" style="font-family: 'Nanum Myeongjo', serif;">
            <div class="h-full mb-16">
                ...
                <div class="continent-container w-full mb-2">
                    <div onclick="location.href='/bartizan?continent=Europe'" class="continent-card border border-gray-300 flex flex-col bg-white h-16 rounded text-center items-center align-items-center justify-center">
                        <span class="continent-name">유럽</span>
                        <span class="continent-name-en">EUROPE</span>
                    </div>
                    <div onclick="location.href='/bartizan?continent=Asia'" class="continent-card border border-gray-300 flex flex-col bg-white h-16 rounded text-center items-center align-items-center justify-center">
                        <span class="continent-name">아시아</span>
                        <span class="continent-name-en">ASIA</span>
                    </div>
                    <div onclick="location.href='/bartizan?continent=America'" class="continent-card border border-gray-300 flex flex-col bg-white h-16 rounded text-center items-center align-items-center justify-center">
                        <span class="continent-name">아메리카</span>
                        <span class="continent-name-en">AMERICA</span>
                    </div>
                    <div onclick="location.href='/bartizan?continent=Africa'" class="continent-card border border-gray-300 flex flex-col bg-white h-16 rounded text-center items-center align-items-center justify-center">
                        <span class="continent-name">아프리카</span>
                        <span class="continent-name-en">AFRICA</span>
                    </div>
                    <div onclick="location.href='/bartizan?continent=Oceania'" class="continent-card border border-gray-300 flex flex-col bg-white h-16 rounded text-center items-center align-items-center justify-center">
