...
{{--    </a>--}}
    ...
    <a id="" href="/bartizan" class="nav_btn w-1/5  cursor-pointer flex flex-grow items-center justify-center p-2 @if(str_contains($_SERVER["REQUEST_URI"], "/bartizan")) text-green-500 @else text-gray-800 @endif active:text-theme-01">
        <div class="text-center">
    ...
    <a id="" href="/nation" class="nav_btn w-1/5  cursor-pointer flex flex-grow items-center justify-center p-2 @if(str_contains($_SERVER["REQUEST_URI"], "/nation")) text-green-500 @else text-gray-800 @endif active:text-theme-01">
        <div class="text-center">
