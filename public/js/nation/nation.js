  ...
  methods: {
    getNations: function () {
      ...
      function getNations(_x) {
        return _getNations.apply(this, arguments);
      }

      return getNations;
    }(),
    getBackgroundImage: function getBackgroundImage(country_code) {
      var image_url = IMAGE_PATH + "/" + country_code.toLowerCase() + ".png";
      return {
        backgroundImage: 'url(' + image_url + ')'
      };
    },
    moveToNationDetail: function moveToNationDetail(nation_id) {
      location.href = "/nation/" + nation_id;
    },
    observingInfiniteScroll: function observingInfiniteScroll() {
      console.log("observingInfiniteScroll");
      var nation_list = document.querySelector('#nation_list'); // 관찰할 대상(요소)

      var scroll_point = document.querySelector('#scroll_point'); // 관찰할 대상(요소)

      var options = {
        root: null,
        // 뷰포트를 기준으로 타켓의 가시성 검사
      ...
      var observer = new IntersectionObserver(onIntersect, options); // 관찰자 초기화
