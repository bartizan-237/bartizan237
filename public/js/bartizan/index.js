...
"use strict";
/*!****************************************!*\
  !*** ./resources/js/bartizan/index.js ***!
  \****************************************/
...
var bartizanList = new Vue({
  ...
  methods: {
    refineBartizanName: function refineBartizanName(name, district) {
    ...
    getBartizans: function () {
      ...
      function getBartizans(_x) {
        return _getBartizans.apply(this, arguments);
      }
    ...
    moveToBartizanDetail: function moveToBartizanDetail(bartizan_id) {
    ...
    observingInfiniteScroll: function observingInfiniteScroll() {
      ...
      var bartizan_list = document.querySelector('#bartizan_list'); // 관찰할 대상(요소)
